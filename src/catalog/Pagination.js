    ...
    return (
        <div>
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-6">
                        <div className="form-inline m-4 my-lg-0">
                            ...
                            <div className="d-none d-sm-block p-3 text-right bott">Ditampilkan 1-20 dari 40 hasil</div>
                        </div>
                    </div>
                    <div className="col-6">
                        {/* <!-- PAGINATION PC --> */}
                ...
                <div className="d-block d-sm-none p-3 text-right tampil">Ditampilkan 1-20 dari 40 hasil</div>
            </div>
        </div>
    );
}
