    ...
    return (
        <div>
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-6">
                        <div className="form-inline m-4 my-lg-0">
                            {/* <!-- PAGE LIST PC --> */}
                            <select className="d-none d-sm-block custom-selectd mb-0">
                                <option value="">Show 15 {/* <i className="fa fa-angle-down"></i> */}
                                </option>
                            ...
                            <div className="d-none d-sm-block p-3 text-right">Ditampilkan 1-20 dari 40 hasil</div>
                        </div>
                    </div>
                    <div className="col-6">
                        {/* <!-- PAGINATION PC --> */}
                        <div className="d-none d-sm-block m-4 my-lg-0">
                            <ul className="list-group list-group-horizontal mt-2 justify-content-end">
                                <li className="list-group-item bg-info text-white">1</li>
                                <li className="list-group-item">2</li>
                                <li className="list-group-item">3</li>
                                <li className="list-group-item next">
                ...
                <div className="d-block d-sm-none p-3 text-right">Ditampilkan 1-20 dari 40 hasil</div>
            </div>
        </div>
    );
}
