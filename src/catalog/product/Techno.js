...
import ProductImage from '../img/katalog-1.png';
        ...
        <div className="App">
            ...
            <div className="card">
                <div className="text-center">
                    ...
                    <a href="detail.html">
                        <img className="card-img-top catalog" src={ProductImage} alt="Techno"/>
                    </a>
                </div>
                <div className="card-body">
                    <a href="detail.html" className="product-name">Techno Tip PPS7</a>
                    <br></br>
